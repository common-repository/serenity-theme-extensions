 ...
 */
class Serenity_Showcase_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array( 
            'classname' => 'serenity-showcase-widget', 
            'description' => __('Add a showcase detail to the Showcase section of the One-page Template.', 'serenity-lite'),
	    'customize_selective_refresh' => true,
        );
        parent::__construct( 'serenity_showcase', __('Showcase Widget', 'serenity-lite'), $widget_ops );
    ...
    function widget( $args, $instance ) {
        ...
        if( $text ) {
            echo '<i class="'.$style.' fa-'.$text.' fa-2x icon text-green mb-3" style="color:'.$color.' !important;"></i>';
        }
        if( $image_url) {
            echo '<img  src="'.$image_url.'" class="image mt-2 mb-4">';
        }
    ...
    ?>
	<p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Showcase Title', 'serenity-lite'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
    </p>
    <p>
        <label for="<?php echo $this->get_field_id('style'); ?>"><?php esc_html_e('Showcase Icon Style', 'serenity-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('text'); ?>"><?php esc_html_e('Showcase Icon Name', 'serenity-lite'); ?></label>
    ...
    <p>
        ...
        <label for="<?php echo $this->get_field_id( 'color' ); ?>"><?php esc_html_e('Showcase Icon Color', 'serenity-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('image_url'); ?>"><?php esc_html_e('Showcase Icon Image', 'serenity-lite'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('textarea'); ?>"><?php esc_html_e('Showcase Description', 'serenity-lite'); ?></label>
...
add_action( 'widgets_init', function() {
    register_widget( 'Serenity_Showcase_Widget' );
} );
?>